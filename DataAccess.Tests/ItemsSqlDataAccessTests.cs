...
using DataAccess.Tests.TestHelper;
...
namespace DataAccess.Tests
{
    ...
    public class ItemsSqlDataAccessTests
    {
        ...
        public void Setup()
        {
            ...
            _mockItemContext = new Mock<ItemContext>();
        }
        ...
        public async Task AddItemTest_Success()
        {
            ...
            ItemsSqlDataAccess itemsSqlDataAccess = new ItemsSqlDataAccess(_mockDbContextFactory.Object);
        ...
        public async Task GetAllItemsTest_Success()
        {
            ...
            ItemsSqlDataAccess itemsSqlDataAccess = new ItemsSqlDataAccess(_mockDbContextFactory.Object);
            List<Item> items = await itemsSqlDataAccess.GetAllItemsAsync();
        ...
        //    ItemsSqlDataAccess itemsSqlDataAccess = new ItemsSqlDataAccess(_mockDbContextFactory.Object);
        //    bool result = await itemsSqlDataAccess.DoesItemExist(1); //item with id = 1 exists
        ...
        private Mock<DbSet<Item>> GetDefaultItemsDbSet()
        {
            ...
            //mockItemSet.As<IAsyncEnumerable<Item>>().Setup(x => x.GetAsyncEnumerator(It.IsAny<CancellationToken>()))
            //                                            .Returns(new TestAsyncEnumerator<Item>(itemList.GetEnumerator()));

            mockItemSet.As<IAsyncEnumerable<Item>>().Setup(x => x.GetAsyncEnumerator(It.IsAny<CancellationToken>()))
                                                        .Returns(new MockQueryable.EntityFrameworkCore.TestAsyncEnumerator<Item>(itemList.GetEnumerator()));
